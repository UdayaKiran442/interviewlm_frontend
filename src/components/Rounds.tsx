        ...
        rounds.map((round, index) => (
          <div key={index} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <option value="Behavioral Interview">
                    Behavioral/HR/Culture fit Interview
                  </option>
                </Select>
              </div>
              <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    updateRound(index, "questionType", e.target.value)
                  }
                >
            ...
            <div className="flex items-center space-x-2 mt-4">
              <input
                onChange={(e) => updateRound(index, "isAI", e.target.checked)}
                checked={round.isAI ?? true}
                type="checkbox"
                id="isAI"
                name="isAI"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  updateRound(index, "roundDescription", e.target.value)
                }
              />
            </div>
          </div>
